...
```bash
curl -fsSL https://raw.githubusercontent.com/WayneTechLab/CSA-iLEM/0.3.2/install-remote.sh | bash -s -- --ref 0.3.2
```
...
- copies the production bundle into `~/.local/share/csa-iem/0.3.2`
...
```powershell
powershell -ExecutionPolicy Bypass -Command "iwr https://raw.githubusercontent.com/WayneTechLab/CSA-iLEM/0.3.2/install-remote.ps1 -OutFile $env:TEMP\csa-iem-install.ps1; & $env:TEMP\csa-iem-install.ps1 --ref 0.3.2"
```
