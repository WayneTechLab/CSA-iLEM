...
- Preserved macOS file flags on individually copied symlinks, including the Finder hidden flag, so legacy link metadata is represented exactly instead of failing after a byte-identical copy.
