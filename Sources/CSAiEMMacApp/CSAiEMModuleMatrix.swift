...
struct CSAiEMModuleTag: Identifiable, Hashable, Codable {
  ...
  static let catalog: [CSAiEMModuleTag] = [
    ...
    .init(id: "smart-logic", name: "Smart Logic and decision matrix", area: "Engine", version: "smart-logic-v2.7", tag: "engine.smart-logic", state: "phase-13.12", lastUpdated: "2026-08-13"),
    ...
    .init(id: "research-workspace", name: "Deep research workspace", area: "Feature", version: "research-v1.7", tag: "feature.research", state: "phase-13.12", lastUpdated: "2026-08-13"),
