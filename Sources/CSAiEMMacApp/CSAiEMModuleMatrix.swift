...
struct CSAiEMModuleTag: Identifiable, Hashable, Codable {
  ...
  static let catalog: [CSAiEMModuleTag] = [
    ...
    .init(id: "smart-logic", name: "Smart Logic and decision matrix", area: "Engine", version: "smart-logic-v3.5", tag: "engine.smart-logic", state: "phase-13.20", lastUpdated: "2026-08-13"),
    ...
    .init(id: "research-workspace", name: "Deep research workspace", area: "Feature", version: "research-v2.5", tag: "feature.research", state: "phase-13.20", lastUpdated: "2026-08-13"),
