...
struct CSAiEMModuleTag: Identifiable, Hashable, Codable {
  ...
  static let catalog: [CSAiEMModuleTag] = [
    ...
    .init(id: "smart-logic", name: "Smart Logic and decision matrix", area: "Engine", version: "smart-logic-v4.6", tag: "engine.smart-logic", state: "phase-13.31", lastUpdated: "2026-08-13"),
    ...
    .init(id: "transfer-receipts", name: "Transfer receipts", area: "Engine", version: "receipt-v3.4", tag: "engine.receipts", state: "phase-13.31", lastUpdated: "2026-08-13"),
    ...
    .init(id: "research-workspace", name: "Deep research workspace", area: "Feature", version: "research-v3.4", tag: "feature.research", state: "phase-13.31", lastUpdated: "2026-08-13"),
